...
interface CalendarWidgetUltimateProps {
  attendanceData?: EmployeeAttendance[];
  onDateSelect?: (date: Date) => void;
  viewMode?: "month" | "week" | "day";
}

const CalendarWidgetUltimate = ({
  attendanceData = [],
  onDateSelect = () => {},
  viewMode = "month",
}: CalendarWidgetUltimateProps) => {
        ...
        <div className="border rounded-md overflow-hidden">
          {hours.map((hour) => (
            <div key={hour} className="flex border-b last:border-b-0">
              <div className="w-20 p-2 border-r bg-gray-50 text-sm font-medium flex items-center">
          ...
          >
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="week" className="flex items-center">
                <Users className="h-4 w-4 mr-1" /> Week
              </TabsTrigger>
              <TabsTrigger value="day" className="flex items-center">
                <Bell className="h-4 w-4 mr-1" /> Day
              </TabsTrigger>
            </TabsList>
...
export default CalendarWidgetUltimate;
